...
class ScheduleManagementTest extends TestCase
{
    ...
    public function test_attendant_can_view_daily_schedule(): void
    {
        ...
        $this->actingAs($attendant)
            ...
            ->assertSee('schedule.index.v1')
            ->assertSee('data-tour="schedule-date-filter"', false)
            ->assertSee('data-tour="schedule-business-hours"', false)
            ->assertSee('data-tour="schedule-hourly-slots"', false)
            ->assertSee('data-tour="schedule-summary"', false)
            ->assertSee('data-tour="schedule-timeline"', false)
            ->assertSee('data-tour="schedule-timeline-item"', false)
